        ...
        <ul className="statistics-list">
          ...
          <li className="stat-item level-item level-flex-container">
            ...
            <div className="xp-bar">
              <div className="xp-bar-filled" style={{ width: `${xpProgress.percentage}%` }}></div>
              <div className="xp-text">{xpProgress.currentLevelXp} / {xpProgress.xpNeededForNextLevel} XP</div>
            </div>
          </li>
        </ul>
      </div>
